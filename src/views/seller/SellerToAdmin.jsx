...
const SellerToAdmin = () => {
    ...
    useEffect(() => {
        // Marquer les notifications de support comme lues quand les messages sont affichés
        if (seller_admin_message.length > 0) {
            dispatch(clear_chat_counts_backend({ type: 'support' }))
        }
    },[seller_admin_message.length, dispatch])
