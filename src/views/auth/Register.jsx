...
const Register = () => {
    ...
    <form onSubmit={submit}>
        ...
        <div className='w-full'><Link className='bg-slate-800 w-full hover:shadow-blue-300/ hover:shadow-lg text-white font-semibold rounded-md px-7 py-2 mb-3  block text-center' to="/login">Se connecter</Link></div>
